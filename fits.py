...
#################################################
# Para ejecutar este ejemplo en esta máquina local use el comando:
# $ ./spark-submit --packages "com.github.astrolabsoftware:spark-fits_2.12:1.0.0" --master spark://saul-pc:7077 /media/saul/Saul\'s\ File/UCSP/BigData/Labs/SparkFits/fits.py -inputpath /media/saul/Saul\'s\ File/UCSP/BigData/Labs/SparkFits/spark-fits/src/test/resources/test_file.fits
##################################################
